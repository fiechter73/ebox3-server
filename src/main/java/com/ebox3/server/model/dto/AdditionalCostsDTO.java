...
public class AdditionalCostsDTO {
  ...
  public String toString() {
    return "AdditionalCostsDTO [id=" + id + ", rechnungsart=" + rechnungsart + ", statusText=" + statusText
        + ", billingDate=" + billingDate + ", title=" + title + ", text=" + text + ", positiontext1=" + positiontext1
        + ", positionprice1=" + positionprice1 + ", positiontext2=" + positiontext2 + ", positionprice2="
        + positionprice2 + ", positiontext3=" + positiontext3 + ", positionprice3=" + positionprice3
        + ", positiontext4=" + positiontext4 + ", positionprice4=" + positionprice4 + ", positiontext5=" + positiontext5
        + ", positionprice5=" + positionprice5 + ", mwstPrice=" + mwstPrice + ", mwstSatz=" + mwstSatz
        + ", sumBruttoPrice=" + sumBruttoPrice + ", createdDate=" + createdDate + ", updatedDate=" + updatedDate
        + ", contractId=" + contractId + ", contractStartDate=" + contractStartDate + ", contractEndDate="
        + contractEndDate + ", contractStatusText=" + contractStatusText + ", contractQuitPeriode="
        + contractQuitPeriode + ", customerId=" + customerId + ", customerAndrede=" + customerAndrede
        + ", customerVornameName=" + customerVornameName + ", customerStrasse=" + customerStrasse + ", customerOrtPlz="
        + customerOrtPlz + "]";
  }
