...
public class Contract extends AuditModel {
  ...
  public Contract(Date startDate, Date endDate, Date terminateDate, Date checkOutDate, boolean active, String statusText,
      Double guthaben, String frist, String bemerkungen, Long minDuration) {
  ...
  public String toString() {
    return "Contract [id=" + id + ", startDate=" + startDate + ", endDate=" + endDate + ", terminateDate="
        ...
        + bemerkungen + ", contractHistory=" + contractHistory + ", payment=" + payment + ", eboxs=" + eboxs
        + ", additionalCosts=" + additionalCosts + ", customer=" + customer + "]";
  }
